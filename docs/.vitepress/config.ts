      ...
      '/guide/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Caching', link: '/guide/caching' },
              { text: 'Storage Lifecycle', link: '/guide/storage-lifecycle' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Schema Migration', link: '/guide/advanced/schema-migration' },
      ...
      '/api/': [
        {
          ...
          items: [
            ...
            { text: 'Audit (REST)', link: '/api/audit' },
              { text: 'Storage Diagnostics (REST)', link: '/api/storage' },

...
impl HasuraV2ResolverGenerator {
    ...
    pub fn generate_resolvers(&self, models: &[Model]) -> Result<String> {
        ...
        println!("[DEBUG] Resolver generation completed. Total length: {}", resolvers.len());
        Ok(resolvers)
    }
...
"#)
    ...
    fn generate_query_resolvers(&self, models: &[Model]) -> Result<String> {
        ...
        query_impl.push_str(r#"    /// Internal method to ensure content block types are registered in the schema
...
"#);
        ...
        println!("[DEBUG] Platform queries generated: {} characters", platform_queries.len());
